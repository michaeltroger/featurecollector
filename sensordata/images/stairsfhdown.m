...
M =csvread("csv/stairsfhdown.csv_octave.csv");
time = M(:, 1);
...
#xlim([20 33]);
ylim([958.3 959.4]);
print('-dpng', 'octave_print/stairsfhdown_p.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown_a.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown_m.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown_g.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown_la.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown_atotal.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown_latotal.png');