...
M =csvread("csv/stairsfhdown6.csv_octave.csv");
time = M(:, 1);
...
#xlim([20 33]);
ylim([958.3 959.4]);
print('-dpng', 'octave_print/stairsfhdown6_p.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown6_a.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown6_m.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown6_g.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown6_la.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown6_atotal.png');
...
#xlim([20 33]);
#ylim([959 959.5]);
print('-dpng', 'octave_print/stairsfhdown6_latotal.png');